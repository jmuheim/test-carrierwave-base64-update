...
RSpec.describe User, type: :model do
  ...
  it "creates a file from a base64 string" do
    ...
    re_encoded_base64 = Base64.strict_encode64(File.open(User.last.string_upload.file.file).read)
  ...
  it "updates a file from a base64 string" do
    ...
    expect(file_to_base64(User.last.string_upload.file.file)).to eq base64_2
  end
  ...
  describe 'nested attachments' do
    it "creates a file from a base64 string" do
      ...
      expect(file_to_base64(File.open(user.attachments.last.string_upload.file.file))).to eq base64_1
    end
    ...
    it "updates a file from a base64 string" do
      ...
      re_encoded_base64 = user.attachments.last.string_upload.file.file
